...
parser.add_argument('-w,--width',dest='width',default=640)
parser.add_argument('-h,--height',dest='height',default=480)
...
camera = VideoCapture(video_device=1,width=640,height=480)
